    ...
    public class EntityManager
    {
        ...
        public static ДолжникиDataTable FilterDOL(string condition = null)
        {
            ...
            var filterEmployeesCommand = new OleDbCommand()
            {
                ...
                CommandText = "SELECT Id, [Номер дела], [ФИО должника],[Серия паспорта должника], [Номер паспорта должника], [Дата рождения должника], [ИНН должника]," +
                " [ФИО взыскателя], [Серия паспорта взыскателя], [Номер паспорта взыскателя], [Дата рождения взыскателя],[ИНН взыскателя]," +
                " [ФИО ребёнка], [№ свидетельсва о рождении], [Дата рождения ребёнка],[Пристав-исполнитель], Долг," +
                "[Дата заведения дела], [Тип взыскания], [Размер взыскания], [Дата окончания дела]," +
                "[Счёт получателя], [Банк получателя], [БИК банка получателя], [Организация] " +
