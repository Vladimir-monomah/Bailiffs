...
namespace Приставы.Формы
{
    public partial class Реквизиты_банка : Form
    {
        ...
        {
            var deleteBANK = MessageBox.Show("Вы действительно хотите удалить реквизиты банка?", "Информация",
            ...
            this.реквизиты_банкаTableAdapter.Update(приставыDataSet.Реквизиты_банка);
        }
    }
}
